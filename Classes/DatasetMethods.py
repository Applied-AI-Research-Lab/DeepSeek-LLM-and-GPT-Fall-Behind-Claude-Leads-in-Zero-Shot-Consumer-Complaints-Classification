...
DTS = DatasetMethods(dataset_path='dataset.csv')

# # Identify the unique labels in a specific column (column_name) to understand your dataset
# DTS.display_unique_values(column_name='product')

# Find min, max, avg for a specific column
# print(DTS.find_max_min_avg_length('narrative'))

# Create a new dataset with rows where the text in the column has less than max_len characters.
# print(DTS.remove_max_len_rows('narrative', 500))

# Remove unwanted columns
# print(DTS.remove_columns_and_save(['']))

# # Clean and standardize specific rows and value in your dataset
# print(DTS.standardize_and_write_csv(['narrative']))

# Remove empty rows after standardization
# print(DTS.remove_rows_with_empty_fields(['product','narrative']))
...
# print(DTS.create_stratified_subset(total_rows=1000, stratified_column='product'))
